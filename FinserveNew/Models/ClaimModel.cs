...
namespace FinserveNew.Models
{
    public class Claim
    {
        ...
        // Employee ID as a simple string field (no foreign key relationship)
        ...
        // Approval ID as a simple integer field (no foreign key relationship)
        [Display(Name = "Approval ID")]
        public int? ApprovalID { get; set; }

        // REMOVED: Navigation properties that create foreign key relationships
        // - public virtual Employee Employee { get; set; } = null!;
        // - public virtual Approval? Approval { get; set; }
        // - public virtual ICollection<ClaimDetails> ClaimDetails { get; set; } = new List<ClaimDetails>();
    }
